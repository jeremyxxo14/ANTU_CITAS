...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #E2688F, #F3BB2A); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>ANTÜ</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="img/antu_profesionales/antu.png" alt="" style="width: 50%;padding-left: 40px;margin-top: 100px;margin-left: 100px;margin-bottom:15px">
      </div>
